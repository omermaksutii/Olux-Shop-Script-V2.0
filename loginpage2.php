...
?>
<h4> <b><span class='glyphicon glyphicon-fire'></span> Jerux SHOP - Signup</b> </h4>
<div id='errorbox'>
</div>
...
<br>
<div class='wrapper'>
    <button type='button' class='btn btn-default btn-xs' onclick="logindiv(1,'Login - Jerux SHOP','login.html',0);">Already Have Account ? Login</button>
</div>
