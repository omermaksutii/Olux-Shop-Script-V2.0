...
?>
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="tickets.html" onclick="pageDiv(11,'Tickets - JeruxShop','tickets.html',0); return false;">Tickets <span class="label label-info"><span id="tickets"></span><?php
$s1 = mysqli_query($dbcon, "SELECT * FROM ticket WHERE status=1");
...
?></span></a></li>
            <li><a href="reports.html" onclick="pageDiv(12,'Reports - JeruxShop','reports.html',0); return false;">Reports <span class="label label-info"><span id="reports"></span><?php
$s1 = mysqli_query($dbcon, "SELECT * FROM reports WHERE status=1");
$r1 = mysqli_num_rows($s1);
echo $r1;
?></span> <?php
